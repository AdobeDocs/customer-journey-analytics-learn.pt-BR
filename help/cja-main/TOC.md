...
+ Análise guiada {#guided-analysis}
   ...
   + Retenção {#retention}
      + [Análise de taxas de retenção](guided-analysis/retention/retention-rates-analysis.md)
   + Tendências {#trends}
      + [Análise de tendências de frequência](guided-analysis/trends/frequency-trends-analysis.md)
