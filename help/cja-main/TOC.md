...
+ Noções básicas do Customer Journey Analytics {#cja-basics}
  ...
  + [Por que o CJA? Revisão estratégica do CJA versus Adobe Analytics](cja-basics/why-cja-modernize-customer-analytics.md)
  + [Introdução ao Customer Journey Analytics](cja-basics/understanding-customer-journey-analytics.md)
  + [Analytics para CJA: novos termos e como eles são mapeados](cja-basics/new-terms-and-concepts-in-cja.md)
...
+ Customer Journey Analytics B2B Edition {#b2b}
  ...
  + [CJA B2B edition - Além das primeiras perguntas](b2b/cja-b2b-beyond-the-first-questions.md)
  + [Integrar o CJA ao Marketo para insights B2B](b2b/integrate-cja-with-marketo-for-b2b-insights.md)
+ Servidor MCP remoto {#remote-mcp-server}
  + [Visão geral do servidor MCP remoto para CJA](remote-mcp-server/remote-mcp-server-for-cja-overview.md)
  + [Servidor MCP remoto para CJA em ação](remote-mcp-server/remote-mcp-server-for-cja-in-action.md)
...
+ Conexões {#connections}
  ...
  + [Sincronizar com o data warehouse externo](connections/cja-data-mirror-sync-external-platforms.md)
  ...
  + [Introdução à análise de público-alvo](connections/get-started-with-audience-analysis.md)
+ Identificação do visitante {#visitor-id}
  ...
  + [Visão geral da compilação](visitor-id/overview-of-stitching.md)
  + [Validar dados e compilar a qualidade usando visualização](visitor-id/validate-identity-stitching-quality.md)
  + [Habilitação e validação da compilação](visitor-id/stitching-enablement-and-validation.md)
...
+ Visualizações de dados {#data-views}
  ...
  + [Criar fontes de dados na camada dos resumos](data-views/create-summary-level-data-sources.md)
  ...
  + Campos derivados{#derived-fields}
    ...
    + [Usar a função de próximo ou anterior](data-views/derived-fields/use-the-next-previous-function-in-derived-fields.md)
    ...
    + [Usar a matemática de datas para calcular o tempo entre eventos](data-views/derived-fields/use-date-math-to-calculate-time-between-events.md)
+ Data Insights Agent {#data-insights-agent}
  ...
  + [Integração com o Microsoft 365 Copilot](data-insights-agent/data-insights-with-marketing-agent-365copilot.md)
+ Analysis Workspace {#analysis-workspace}
  + Projetos do Workspace {#workspace-projects}
    ...
    + [Comentários no espaço de trabalho](analysis-workspace/workspace-projects/workspace-commenting.md)
    + Análise de jornadas {#journey-analysis}
  ...
  + Painéis {#panels}
    ...
    + [Criar o painel de atribuições](analysis-workspace/panels/build-the-attribution-panel.md)
    ...
    + [Usar o painel de insights rápidos](analysis-workspace/panels/use-the-quick-insights-panel.md)
  + Modelos {#templates}
  ...
  + Tabelas de forma livre {#freeform-tables}
    ...
    + [Explorar configurações de linha e coluna em tabelas de forma livre](analysis-workspace/freeform-tables/cja-explore-row-and-column-settings-in-freeform-tables.md)
  + Visualizações {#visualizations}
    ...
    + [Vinculação em tempo real do gráfico Dimension](analysis-workspace/visualizations/dimension-graph-live-linking.md)
    + [Criar legendas inteligentes](analysis-workspace/visualizations/intelligent-captions.md)
    + [Configurações da fonte de dados de tabelas e visualizações](analysis-workspace/visualizations/cja-configure-table-and-visualization-data-source-settings.md)
    ...
    + [Adicionar linhas de tendência às visualizações de linha](analysis-workspace/visualizations/cja-add-trendlines-to-line-visualizations.md)
    + [Usar a função média cumulativa para suavização de métricas](analysis-workspace/visualizations/cja-use-the-cumulative-average-function-for-metric-smoothing.md)
    ...
    + [Personalizar legendas de visualização](analysis-workspace/visualizations/cja-customize-visualization-legends.md)
    + [Definir a granularidade para visualizações](analysis-workspace/visualizations/cja-set-granularity-for-visualizations.md)
  ...
  + Calendário e intervalos de datas {#calendar-and-date-ranges}
    + [Usar calendários e datas no Analysis Workspace](analysis-workspace/calendar-and-date-ranges/cja-calendar-and-dates-in-analysis-workspace.md)
    + [Aplicar intervalos de datas reutilizáveis no projeto](analysis-workspace/calendar-and-date-ranges/cja-apply-reusable-date-ranges-in-your-project.md)
    + [Usar intervalos de datas e comparações](analysis-workspace/calendar-and-date-ranges/cja-use-date-ranges-and-comparisons.md)
  + Anotações {#annotations}
    + [Criar uma anotação](analysis-workspace/annotations/create-an-annotation.md)
  + Preparar e compartilhar {#curate-and-share}
    + [Narração de histórias com dados: gerar apresentações de slides](analysis-workspace/curate-and-share/data-storytelling-generate-slides.md)
...
+ Componentes {#components}
  + Segmentos {#filters}
    ...
    + [Segmentação no nível do objeto usando subeventos](components/filters/object-level-segmentation-using-sub-events.md)
  ...
  + Públicos-alvo {#audiences}
    + [Publicação de públicos-alvo](components/audiences/audience-publishing-for-cja.md)
...
+ Content Analytics {#content-analytics}
  ...
  + [Geração de relatórios](content-analytics/reporting.md)
...
+ Exportando {#exporting}
  ...
  + [Administrar e gerenciar exportações completas de tabela](exporting/manage-full-table-exports.md)
...
+ Gerenciador de atividades de relatórios {#reporting-activity-manager}
  + [Usar o gerenciador de atividades de geração de relatórios](reporting-activity-manager/use-the-reporting-activity-manager.md)
+ Integração com a Experience Platform {#experience-platform-integration}
  + [Geração de relatórios aprimorada do Adobe Journey Optimizer](experience-platform-integration/enhanced-reporting-for-adobe-journey-optimizer.md)
+ Casos de uso {#use-cases}
  + Inteligência Artificial {#ai}
    + [Rastrear e analisar o tráfego de IA](use-cases/ai/track-and-analyze-ai-traffic.md)
    + [Validar a qualidade do conjunto de dados com o Data Engineering Agent](use-cases/ai/validate-dataset-quality-data-engineering-agent.md)
