...
description: Ao adicionar ou criar uma visualização a partir de um valor de dimensão, você pode selecionar diferentes valores de dimensão e alterar o gráfico dinamicamente ou bloquear a visualização para permanecer em uma dimensão ou local.
...
# Vinculação em tempo real do gráfico Dimension no Analysis Workspace
