...
Para obter mais informações sobre as visualizações de [!UICONTROL gráfico de dispersão], visite a [documentação](https://experienceleague.adobe.com/docs/analytics-platform/using/cja-workspace/visualizations/scatterplot.html?lang=pt-BR){target="_blank"}.
