...
Para obter mais informações sobre o conector de origem [!DNL Adobe Analytics] para dados de [!UICONTROL classificações], consulte a [documentação](https://experienceleague.adobe.com/docs/experience-platform/sources/ui-tutorials/create/adobe-applications/classifications.html?lang=pt-BR){target="_blank"}.

O recurso de campos derivados no Customer Journey Analytics é referenciado neste vídeo. Para saber mais sobre este recurso, assista ao [vídeo](https://experienceleague.adobe.com/docs/customer-journey-analytics-learn/tutorials/data-views/derived-fields-in-cja.html?lang=pt-BR){target="_blank"} ou visite a [documentação](https://experienceleague.adobe.com/docs/analytics-platform/using/cja-dataviews/derived-fields.html?lang=pt-BR){target="_blank"}.
